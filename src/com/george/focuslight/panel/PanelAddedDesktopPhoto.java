...
import com.george.focuslight.util.AppUtils;
...
public class PanelAddedDesktopPhoto extends SelfInflaterPanel implements OnClickListener, AjaxRequestListener, IPopPanelAction4ObjectPanel{
	...
	public PanelAddedDesktopPhoto(Context context, LinearLayout baseLayout, IPanelAction panelAction) {
	...
	private boolean  _confirmExit(){
		...
		.setTitle(res.getString(R.string.title_delete_desktop))  
	...
	private void	_initWork(){
		...
		title.setText(_context.getResources().getString(R.string.label_desktop_photo));
	...
	public void onUpdateProgress(long total, long current) {
		// TODO Auto-generated method stub
		Utils.amLog("upload desktopPhoto progress current:"+current+", total:"+total);
	}

	@Override
	public void setObject() {
		_panelAction.setDesktop();
	}
